...
describe('SVG', () => {
  ...
  // setText test ensures that the rendered SVG has the correct characters inputted by the user. Also ensures that it throws an error whenever user input exceeds three characters. 
  describe('setText', () => {
